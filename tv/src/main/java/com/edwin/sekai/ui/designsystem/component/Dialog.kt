...
fun FullScreenDialog(
    ...
    Dialog(
        ...
        Box(
            ...
            Column(
                modifier = Modifier
                    .fillMaxWidth(FullScreenDialogDefaults.DIALOG_MAX_WIDTH)
                    .then(modifier),
...
object StandardDialogDefaults {
    ...
    private const val TEXT_COLOR_OPACITY = 0.8f
    ...
    val textStyle
        ...
        @Composable get() = MaterialTheme.typography.bodyLarge
            .copy(color = LocalContentColor.current.copy(alpha = TEXT_COLOR_OPACITY))
...
object FullScreenDialogDefaults {
    ...
    internal const val DIALOG_MAX_WIDTH = .5f
    ...
    val descriptionTextStyle: TextStyle
        ...
        @Composable get() = MaterialTheme.typography.bodyLarge.copy(
            ...
            color = LocalContentColor.current.copy(alpha = DESCRIPTION_COLOR_OPACITY)
        )
}
